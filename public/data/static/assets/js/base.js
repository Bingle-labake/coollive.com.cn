 ...
 *		：options 扩展选项{expires: 7, path:'/', domain: 'yoka.com'} 有效期(天) 路径 域名。
 */
(function(){
	window.Cookie = {
		read:function(name){
...
(function(){
	...
	function init(){
		...
		win = $('<div class="WIN"><div class="WINCLOSE"></div><div class="WINCON"></div><iframe src="about:blank"></iframe></div>');
		$body.append(winBg);
		$body.append(win);		
