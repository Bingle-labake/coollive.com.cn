 ...
 * @filesource	svn://www.dayrui.net/v2/dayrui/libraries/Field/Linkage.php
 */
...
class F_Linkage extends A_Field {
	...
	public function input($cname, $name, $cfg, $value = NULL) {
		...
		if(!defined('FINECMS_LINKAGE_INIT_LD')) {
			...
			$str.= '<script type="text/javascript" src="'.MEMBER_PATH.'static/js/jquery.ld.js"></script>';
		}
		$level = 1;
		$default = '';
		if ($value) {
