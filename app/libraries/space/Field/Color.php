 ...
 * @filesource	svn://www.dayrui.net/v2/dayrui/libraries/Field/Color.php
 */
...
class F_Color extends A_Field {
	...
	public function input($cname, $name, $cfg, $value = NULL) {
		...
		if (!defined('DAYRUI_COLOR_LD')) {
			$str .= '
			<script type="text/javascript" src="'.MEMBER_PATH.'static/js/spectrum/spectrum.js"></script>
			<link href="'.MEMBER_PATH.'static/js/spectrum/spectrum.css" type="text/css" rel="stylesheet">';
