...
function parse_query_string(){
    ...
    obj['server'] = (typeof(_server) == "undefined")?"srs.labake.cn":_server;
    obj.user_query['server'] = obj['server'];

    obj['port'] = (typeof(_port) == "undefined")?1935:_port;
    obj.user_query['port'] = obj['port'];

    obj['vhost'] = (typeof(_vhost) == "undefined")?"srs.labake.cn":_vhost;
    obj.user_query['vhost'] = obj['vhost'];

    obj['app'] = (typeof(_app) == "undefined")?"live":_app;
    obj.user_query['app'] = obj['app'];

    obj['stream'] = (typeof(_stream) == "undefined")?"demo."+(new Date()).getTime():_stream;
    if(obj['stream'] == "" || obj['stream'] == null) {
        obj['stream'] = "demo."+(new Date()).getTime();
    }
    obj.user_query['stream'] = obj['stream'];
    /*
