			...
			<div class="box">
				...
				<div class="movie">
					<div class="movie-image">
						<a href="/space/video/paly/<?php echo $value['vid']?>" target="_blank"><span class="play"></span><img src="<?php echo $value['image']?>" alt="movie" /></a>
					</div>
					<div class="rating">
						<p><a href="/space/video/paly/<?php echo $value['vid']?>" target="_blank"><?php echo $value['title']?></a></p>
					</div>	
					<div class="rating">
						<p>得分</p>
						<div class="stars">
