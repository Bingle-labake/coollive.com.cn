<ul class="pk_jiList">   
  <!-- 
  <li>我要兑换直投票：<input type="text" name="vote_ticket_ex_num" data-info="{ide:'vote_ticket_ex', hcredits:<?php echo $space['hcredits'];?>, credits:<?php echo $space['credits'];?>}" value="<?php echo $ex_num;?>"> 张
   &nbsp;&nbsp;需要花掉<?php echo abs($credit_config_item['act_score']);?>积分   
   <i data-value="<?php echo $credit_config_item['act_score'];?>" data-ide="" data-act="vote_ticket_ex" class="btn vote_ticket_ex">兑换</i></li>   

   <?php foreach ($magic_list as $k=>$magic) { ?>		       
    <li>我要兑换<?php echo $magic['name'];?>：<input type="text" name="<?php echo $magic['vg_ide'];?>_num" data-info="{ide:'<?php echo $magic['vg_ide'];?>', hcredits:<?php echo $space['hcredits'];?>, credits:<?php echo $space['credits'];?>}" value="<?php echo $magic['num'];?>" /> 张 &nbsp;&nbsp;需要花掉<?php echo abs($magic['act_score']);?>金币   
     <i data-value="<?php echo $magic['act_score'];?>" data-ide="<?php echo $magic['vg_ide'];?>" data-act="<?php echo $magic['vg_ide'];?>" class="btn <?php echo $magic['vg_ide'];?>">兑换</i></li>
   <?php } ?>	
    -->
   <li class="cRed"><a class="blue" href="/api/pay">我要充值</a></li>
</ul>
