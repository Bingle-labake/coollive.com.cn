...
<div class="s_index fY">
    ...
    <div class="snapshots css3img">
			<div class="box">	
				...
				<dl>
					<dt>
						<a href="<?php echo $this->config->item("base_url"); ?>/v/<?php echo strencoder($video['wid']); ?>.html" target="_blank"><img src="<?php echo $video['pic_path']; ?>" width="210px" height="165px"/><i></i></a>
					</dt>
					<dd>
					<a href="<?php echo $this->config->item("base_url"); ?>/v/<?php echo strencoder($video['wid']); ?>.html" target="_blank"><?php echo $video['title']; ?></a>
					</dd>
				</dl>
				<?php } ?>	
			</div>
