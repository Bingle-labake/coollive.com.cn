 ...
 * @filesource	svn://www.dayrui.net/v2/dayrui/libraries/Field/Date.php
 */
...
class F_Date extends A_Field {
	...
	public function option($option) {
		...
		return '<tr>
				...
				<tr>
					...
					<div class="onShow">'.lang('m-091').'</div>
                    </td>
                </tr>
				';
	}
	...
	public function input($cname, $name, $cfg, $value = NULL) {
		...
		// 字段默认值
		if (is_null($value)) {
			$value = $cfg['option']['value'] === 0 ? '' : SYS_TIME;
		} else {
		...
		if (!defined('DAYRUI_DATE_LD')) {
			$str .= '
			<link href="'.MEMBER_PATH.'static/js/calendar/jscal2.css" type="text/css" rel="stylesheet">
			<link href="'.MEMBER_PATH.'static/js/calendar/border-radius.css" type="text/css" rel="stylesheet">
			<link href="'.MEMBER_PATH.'static/js/calendar/win2k.css" type="text/css" rel="stylesheet">
			<script type="text/javascript" src="'.MEMBER_PATH.'static/js/calendar/calendar.js"></script>
			<script type="text/javascript" src="'.MEMBER_PATH.'static/js/calendar/'.SITE_LANGUAGE.'.js"></script>';
