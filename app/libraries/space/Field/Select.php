 ...
 * @filesource	svn://www.dayrui.net/v2/dayrui/libraries/Field/Select.php
 */
...
class F_Select extends A_Field {
	...
	public function option($option) {
		...
		return '<tr>
				...
				<tr>
					...
					<div class="onShow">'.lang('m-080').'</div>
                    </td>
                </tr>
	...
	public function input($cname, $name, $cfg, $value = NULL) {
		...
		$str = '<select name="data['.$name.']" id="dr_'.$name.'" '.$attr.' >';
		if ($options) {
