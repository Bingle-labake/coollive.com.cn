...
<div id="content">
    ...
    <iframe name="getpwdiframe" style="display: none"></iframe>
    <form name="lzform" method="post" action="" target="getpwdiframe">
        <input type="hidden" name="uid" id="uid" value="<?php echo $_GET['uid']; ?>">
        <div class="item extra-tips">
            <label>新密码</label>
            <input onblur="checkpassword()" name="password" id="password" type="text" size="24" tabindex="1" class="basic-input" maxlength="60" value="">
            <span class="validate-error" style="display: none;" id="tip_password"></span>
        </div>
        <div class="item extra-tips">
            <label>确认密码</label>
            <input onblur="checkconfirmpwd()" name="confirmpwd" id="confirmpwd" type="text" size="24" tabindex="1" class="basic-input" maxlength="60" value="">
            <span class="validate-error" style="display: none;" id="tip_confirmpwd"></span>
        </div>
        <div class="item">
        ...
        <div class="item-submit">
            ...
            <button class="btn-submit disabled enabled" tabindex="4" onclick="getpassword()">确定</button>
