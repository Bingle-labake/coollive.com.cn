(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: '',
					 ...
					 li_width : false,
					 jump: true,
           imgClick:function(index){},  //点击图片时候绑定的事件 
           nextClick:function(index){},  //点击图片下一张时候绑定的事件 
           prevClick:function(index){},  //点击图片上一张时候绑定的事件 
...
//      );
    ...
    _showWhenLoaded: function(index, callback) {
      if(this.images[index]) {
        ...
        //img.attr('width', size.width);  //大图宽高
        //img.attr('height', size.height);
        size.height += 24;
        //img_container.css({width: size.width +'px', height: size.height +'px'});  //ad-image的宽高设置
