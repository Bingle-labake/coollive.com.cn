 ...
 * Json 类
 * ==========================================================
 * method:encode($arg, $force = true)
 * method:decode($text,$type=0)
 */

if (!defined('___CHARSET'))
{
    define('___CHARSET', 'utf-8');
}
...
class Json
{
    ...
    function encode($arg, $force = true)
    {
        ...
        if ($_force && ___CHARSET == 'utf-8' && function_exists('json_encode'))
        {
    ...
    function decode($text,$type=0) // 默认type=0返回obj,type=1返回array
    {
        ...
        if (___CHARSET === 'utf-8' && function_exists('json_decode'))
        {
