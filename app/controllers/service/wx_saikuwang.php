 ...
 * ============================================================================
 * $Author: Bingle $
 * $Id: Wx_saikuwang.php 17171 2014-10-21 17:37:00Z Bingle $
*/
class Wx_saikuwang extends CI_Controller {
	...
	const URL        = "http://i.saiku.com.cn/service/wx_saikuwang";
	const WWW_URL    = "http://www.saiku.com.cn";
	const AppId      = "wx30c0b02e1cb58e22";
	const AppSecret  = "baa9124e66ea6be8b764184c5ded023c";
	public $weixin = null;
	protected $username = '';
				...
				switch ($object->EventKey)
				{
					...
					case "WORKS_VIDEO_HOT"://$content = "赛酷网将提供最热的视频。";
						...
						if($works_list) {
							...
							$content = "已经是最后一页了；如果继续将返回第一页。";
							$this->set_wx_page($this->username, 'video_hot', 1);
						}						
						break;
					case "ACTIVITY_PASS"://$content = "赛酷网提供往期的活动。";
						...
						if($game) {
							...
							$content = "已经是最后一页了；如果继续将返回第一页。";
							$this->set_wx_page($this->username, 'activity_pass', 1);
						}	
						break;
					...
					case "VIDEO_BEST"://$content = "视频推荐。";		
						...
						$video_list = $this->recommend_m->get(8, $page, 5);
						...
						if($video_list) {
							...
							$content = "已经是最后一页了；如果继续将返回第一页。";
							$this->set_wx_page($this->username, 'best_video', 1);
						}
						break;
					...
					case "MEMBER_BEST"://$content = "达人推荐。";
							...
							$member_list = $this->recommend_m->get(11, $page, 5);
							$content = array();
							if($member_list) {
								...
								$content = "已经是最后一页了；如果继续将返回第一页。";
							    $this->set_wx_page($this->username, 'best_daren', 1);
					    	}							
							break;
					default:
