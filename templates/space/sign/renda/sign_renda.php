...
function sign(){
   if(!is_sign){
		...
		$.ajax({
			type: "post",
			url: "/space/sign/renda/<?php echo $gid;?>",
			dataType:"json",
			data:{
			...
			success: function(data){
				  if(!data['result']){
					 ...
					 return false;
					  ...
					  window.location.href = '<?php echo $this->config->item('base_url'); ?>/renda/upload/?sid='+data['sid'];
				  }
...
function initial(){
	var tips = ['realname','mobile','idcard','birthday',
	        	'upload','invitecode','sign','sign_notice','sms'
			   ];
...
<div class="register"><div class="rlogo"><img src="<?php echo $this->config->item('img2_url'); ?>/zhuanti/renda/img/logo_reg.png" /></div>
	<div class="rtt">
    	<dl class="reg_top">
        	<dt class="fl"><b>活动时间：</b><?php echo date('Y-m-d',strtotime($game['starttime'])); ?>至<?php echo date('Y-m-d',strtotime($game['endtime'])); ?><br /><b>活动地点：</b><?php echo $game['site']; ?></dt>
            <dd class="fr"><b>主办方：</b><?php echo $game['host']; ?><br /><b>承办方：</b><?php echo $game['undertake']; ?></dd>
        </dl>
    </div>
</div>
<div class="starConter bot_reg">
	<div class="regis">
    	<div class="reg_tit">
        	<h2><img src="<?php echo $this->config->item('img2_url'); ?>/zhuanti/renda/img/icon_button_02_1.png" alt="填写报名信息" /></h2>
        ...
        <div class="reg_form">
            <div class="b_video_form">
            	<dl>
                    <dt>邀请码：</dt>
                    <dd>
                        <input type="text" name="invitecode" id="invitecode" class="b_bm_input" value="" onblur="checkinvitecode();"/>
						<span style="display:none;color:red" id="tip_invitecode"></span>
                   </dd>
                </dl>
                <dl>
                    <dt>真实姓名：</dt>
                ...
                <dl>
                  <dt>上传生活照：</dt>
                    <dd class="uploader">
                        ...
                        <span>（上传生活照有助于提高排名和主页展示机会哦！）</span>-->
                ...
                <dl>
                    <dt class="no"></dt>
                    <dd>
                        <h3><input type="checkbox" name="sign_notice" id="sign_notice" value="1" checked="true" />
	                        &nbsp;&nbsp;<a href="javascript:;void(0)" onClick="$.layer($('#wintmpl1').html());"><img src="<?php echo $this->config->item('img2_url'); ?>/zhuanti/renda/img/icon_button_02_.png" /></a>
...
<script>
$.setValue($("#b_bm_yzm"),function(element){
